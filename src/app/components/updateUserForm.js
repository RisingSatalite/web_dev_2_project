...
export default function UpdateUserForm(){
    ...
    return(
        <form className="grid lg:grid-cols-2 w 4/6 gap-4" onSubmit={handleSubmit}>
          ...
          <button className="flex justify-center text-md w-2/6 bg-red-400 text-gray-800 px-4 py-2 border rounded-md hover:bg-gray-75 hover:border-yellow-500 hover:text-gray-100" >

...
class Event {
  constructor(title, start, allDay, id) {
    this.title = title;
    this.start = start;
    this.allDay = allDay;
    this.id = id;
...
export default function Home() {
  ...
  function handleDateClick({ date, allDay }) {
    setNewEvent({ ...newEvent, date, allDay, id: new Date().getTime() })
    setShowModal(true)
  }

  function addEvent(data) {
    const event = new Event(data.draggedEl.innerText, data.date.toISOString(), data.allDay, new Date().getTime().toString());
